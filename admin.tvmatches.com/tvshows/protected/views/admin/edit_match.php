                                 ...
                                 <?php $form=$this->beginWidget('CActiveForm', array(
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo $form->dropDownList($model,'team1', CHtml::listData(Teams::model()->findAll(), 'team_name', 'team_name'), array('options'=>array($data[0]->team1=>array('selected'=>true))));?>
                                            <?php echo $form->error($model,'team1'); ?>
                                        </div>
                                        <div class="form-group">
                                            <?php echo $form->labelEx($model,'team2'); ?>
                                            <?php echo $form->dropDownList($model,'team2', CHtml::listData(Teams::model()->findAll(), 'team_name', 'team_name'), array('options'=>array($data[0]->team2=>array('selected'=>true))));?>
                                            <?php echo $form->error($model,'team2'); ?>
                                        </div>
                                         <div class="form-group">
                                            <?php echo $form->labelEx($model,'start_date'); ?>
                                            <?php echo $form->textField($model,'start_date',array('class'=>'form-control','id'=>'datepicker','value'=>$data[0]->start_date));?>
                                            <?php echo $form->error($model,'start_date'); ?>
                                        </div>
                                        <div class="form-group">
                                            <?php echo $form->labelEx($model,'date_time'); ?>
                                            <?php echo $form->textField($model,'start_time',array('class'=>'form-control','id'=>'timepicker','value'=>$data[0]->start_time));?>
                                            <?php echo $form->error($model,'start_time'); ?>
                                        </div>
					                    <div class="form-group">
                                            <?php echo $form->labelEx($model,'channel_id'); ?>
                                            <?php echo $form->dropDownList($model,'channel_id', CHtml::listData(Channels::model()->findAll(), 'id', 'name'), array('options'=>array($data[0]->channel_id=>array('selected'=>true))));?>
                                            <?php echo $form->error($model,'channel_id'); ?>
                                        </div>
                                        <div class="form-group">
                                            <?php echo $form->labelEx($model,'channel_id2'); ?>
                                            <?php echo $form->dropDownList($model,'channel_id2', CHtml::listData(Channels::model()->findAll(), 'id', 'name'), array('options'=>array($data[0]->channel_id2=>array('selected'=>true))));?>
