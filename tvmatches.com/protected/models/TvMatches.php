...
{
	public $id,$sport_id,$team1,$team2,$start_time,$start_date,$channel_id,$channel_id2,$status;
	...
	{
		return array(
			array('sport_id,team1,team2,start_date,start_time,start_date,channel_id','required'),
